    ...
    <div className="bg-[#28AEED] overflow-x-hidden ">
      <div>
        <div className="flex justify-between px-2 py-3">
          <img src="/GhibliLogo.webp" className=" w-64 md:w-72 lg:w-80" />
  ...
  return (
    <div
      ...
      <div
        ...
        onClick={onClose}></div>
      <div
        className={`bg-[white]/[0.85] px-8 py-1 w-full h-[13rem] lg:h-[15rem] fixed top-0 transform transition-transform ease-in-out duration-300 ${
        ...
        <div className="flex justify-between h-full">
          <div className="flex flex-col gap-20 max-w-[25%]">
            <a className="underline text-xl">About</a>
            <a className="underline text-xl">Home</a>
          </div>
          ...
          <div className="h-full flex flex-col gap-20">
            <a className="underline text-xl">Favorites</a>
            <a className="underline text-xl">Watchlist</a>
          </div>
        </div>
      </div>
    </div>
